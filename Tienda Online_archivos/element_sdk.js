(() => {
  ...
  function verifyMessage(data, expectedSource, expectedClientId) {
    ...
    if (!source)
      return Result.Err("'source' is missing in MessageEvent data object");
  ...
  const PARENT_RESPONSE_TIMEOUT_MS = 1e3;
        ...
        switch (msg.error) {
          case VerifyError.INVALID_SOURCE:
            errorService.info(msg.error, {
              ...
              extra: new Map([["data.source", data?.source]]),
            });
            break;
    ...
    const getPortWithRetry = async () => {
      ...
      while (count <= MAX_NUM_CONNECTION_ATTEMPTS)
        try {
          ...
          handshakeTimeout = new PromiseWithTimeout(timeoutWithBackoffMs);
          parent.postMessage(initMessage, parentOrigin);
          count++;
        }
      if (port == null)
  ...
  function repeatedField(valueType, jsonFullKey, tag) {
    return {
      tag,
      fieldLabel: FieldLabel.REPEATED,
      jsonFullKey,
      typeOfValue: valueType.typeOfValue,
    };
  }
  ...
  function choosePrimaryAndSecondaryJSONFromConfig(
    ...
    if (dualDeserializationConfig === undefined) return { primary: jsonFull };
  ...
  const InitElementRequest = Proto.createMessage(
    () => ({ config: Proto.requiredString("config", 1) }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
    },
  );
  const InitElementResponse = Proto.createMessage(
    () => ({
      config: Proto.optionalString("config", 1),
      fontEditable: Proto.optionalObject("fontEditable", 2, FontEditable),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const SetConfigRequest = Proto.createMessage(
    () => ({
      config: Proto.requiredString("config", 1),
      recolorables: Proto.repeatedObject("recolorables", 4, Recolorable),
      borderables: Proto.repeatedObject("borderables", 5, Borderable),
      fontEditable: Proto.optionalObject("fontEditable", 6, FontEditable),
      editPanelValues: Proto.repeatedObject(
        "editPanelValues",
        7,
        EditPanelValue,
      ),
      fontSizeable: Proto.optionalObject("fontSizeable", 8, FontSizeable),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const BorderableValue = Proto.createMessage(
    () => ({
      borderRadius: Proto.requiredInt32("borderRadius", 1),
      borderWidth: Proto.requiredInt32("borderWidth", 2),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const EditPanelValue = Proto.createMessage(
    () => ({
      id: Proto.requiredString("id", 1),
      value: Proto.requiredString("value", 2),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const RenderElementRequest = Proto.createMessage(
    () => ({
      config: Proto.optionalString("config", 1),
      fontEditable: Proto.optionalObject("fontEditable", 2, FontEditable),
    }),
  ...
  const RenderElementResponse = Proto.createMessage(
    () => ({
      config: Proto.requiredString("config", 1),
      recolorables: Proto.repeatedObject("recolorables", 4, Recolorable),
      borderables: Proto.repeatedObject("borderables", 5, Borderable),
      ...
      fontSizeable: Proto.optionalObject("fontSizeable", 7, FontSizeable),
      fontEditable: Proto.optionalObject("fontEditable", 8, FontEditable),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const SetCapabilityRequest = Proto.createOneof(
    () => ({
      type: [1, Recolorable, 2, Borderable, 3, FontEditable, 5, FontSizeable],
    }),
  ...
  const Recolorable = Proto.createMessage(
    () => ({
      ...SetCapabilityRequestUnionFields(),
      type: Proto.constantString("type", "RECOLORABLE", 1, "RECOLORABLE"),
      id: Proto.requiredString("id", 1),
      value: Proto.requiredString("value", 2),
    }),
    {
  ...
  const Borderable = Proto.createMessage(
    () => ({
      ...SetCapabilityRequestUnionFields(),
      type: Proto.constantString("type", "BORDERABLE", 2, "BORDERABLE"),
      id: Proto.requiredString("id", 1),
      value: Proto.requiredObject("value", 2, BorderableValue),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const FontEditable = Proto.createMessage(
    () => ({
      ...SetCapabilityRequestUnionFields(),
      type: Proto.constantString("type", "FONT_EDITABLE", 3, "FONT_EDITABLE"),
      id: Proto.requiredString("id", 1),
      url: Proto.requiredString("url", 4),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const FontSizeable = Proto.createMessage(
    () => ({
      ...SetCapabilityRequestUnionFields(),
      type: Proto.constantString("type", "FONT_SIZEABLE", 5, "FONT_SIZEABLE"),
      size: Proto.requiredInt32("size", 21),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const SetCapabilityResponse = Proto.createMessage(
    () => ({ config: Proto.requiredString("config", 1) }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  const SetEditPanelValueRequest = Proto.createMessage(() => ({
    id: Proto.requiredString(1),
    value: Proto.requiredString(2),
  }));
  const SetEditPanelValueResponse = Proto.createMessage(() => ({
    config: Proto.requiredString(1),
  }));
  const ResizeEvent = Proto.createMessage(
    () => ({ body: Proto.requiredObject("body", 1, Dimensions) }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
    },
  ...
  const Dimensions = Proto.createMessage(
    () => ({
      scrollWidth: Proto.requiredInt32("scrollWidth", 1),
      scrollHeight: Proto.requiredInt32("scrollHeight", 2),
      offsetWidth: Proto.requiredInt32("offsetWidth", 3),
      offsetHeight: Proto.requiredInt32("offsetHeight", 4),
    }),
    {
      dualDeserializationConfig:
        DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY,
  ...
  class ElementHostEmitterImpl {
    async sendRenderElement(request) {
      const result = await this.comms.request(
        MessagePaths.RENDER_ELEMENT,
        RenderElementRequest.serialize(request),
      );
      const value = extractValue(result, MessagePaths.RENDER_ELEMENT);
      return RenderElementResponse.deserialize(value);
    }
    async sendSetCapability(request) {
      const result = await this.comms.request(
        MessagePaths.SET_CAPABILITY,
        SetCapabilityRequest.serialize(request),
      );

      const value = extractValue(result, MessagePaths.SET_CAPABILITY);
      return SetCapabilityResponse.deserialize(value);
    }
    async sendSetEditPanelValue(request) {
      const result = await this.comms.request(
        MessagePaths.SET_EDIT_PANEL_VALUE,
        SetEditPanelValueRequest.serialize(request),
      );
      const value = extractValue(result, MessagePaths.SET_EDIT_PANEL_VALUE);
      return SetEditPanelValueResponse.deserialize(value);
    }
    constructor(comms) {
      this.comms = comms;
    }
  ...
  function setupElementRequestHandlers(comms, handler) {
    handleMessageFromHost(
      comms,
      MessagePaths.INIT_ELEMENT,
      InitElementRequest,
      (request) => handler.handleInitElement(request),
      InitElementResponse,
    );
    handleMessageFromHost(
      comms,
      MessagePaths.SET_CONFIG,
      SetConfigRequest,
      (request) => handler.handleSetConfig(request),
      SetConfigResponse,
    );
    handleMessageFromHost(
      comms,
      MessagePaths.RESIZE_EVENT,
      ResizeEvent,
      (request) => handler.handleResizeEvent(request),
    );
  }
  class ElementClientComms {
    async sendInitElement(request) {
      const result = await this.comms.request(
        MessagePaths.INIT_ELEMENT,
        InitElementRequest.serialize(request),
      );
      const value = extractValue(result, MessagePaths.INIT_ELEMENT);
      return InitElementResponse.deserialize(value);
    }
    async sendSetConfig(request) {
      const result = await this.comms.request(
        MessagePaths.SET_CONFIG,
        SetConfigRequest.serialize(request),
      );
      const value = extractValue(result, MessagePaths.SET_CONFIG);
      return SetConfigResponse.deserialize(value);
    }
    async sendResizeEvent(event) {
      await this.comms.request(
        MessagePaths.RESIZE_EVENT,
        ResizeEvent.serialize(event),
      );
    }
    setupRequestHandlers() {
      handleMessageFromHost(
        ...
        (request) => {
          this.errorService.debug("Received RenderElementRequest", {
            extra: new Map([
              [
                "request",
                JSON.stringify(RenderElementRequest.serialize(request)),
              ],
            ]),
          });
      ...
      handleMessageFromHost(
        ...
        (request) => {
          this.errorService.debug("Received SetCapabilityRequest", {
            extra: new Map([
              [
                "request",
                JSON.stringify(SetCapabilityRequest.serialize(request)),
              ],
            ]),
          });
      ...
      handleMessageFromHost(
        this.comms,
        MessagePaths.SET_EDIT_PANEL_VALUE,
        SetEditPanelValueRequest,
        (request) => {
          this.errorService.debug("Received SetEditPanelValueRequest", {
            extra: new Map([
              [
                "request",
                JSON.stringify(SetEditPanelValueRequest.serialize(request)),
              ],
            ]),
          });
          return this.handler.handleSetEditPanelValue(request);
        },
        SetEditPanelValueResponse,
      );
    }
    constructor(comms, handler, errorService) {
      this.comms = comms;
      this.handler = handler;
      this.errorService = errorService;
  ...
  class ConsoleErrorService {
    ...
    createChild(name) {
      return new ConsoleErrorService(`${this.context}:${name}`);
    }
    withOfflineStatus() {}
    setContext(context) {
  ...
  class ElementSdkImpl {
    async setupParentCommunication() {
      const result = await this.connectToParent(
        this.errorService,
        TARGET_ORIGIN,
        window,
        ELEMENT_CLIENT_ID,
      ...
      if (!result.ok)
        return SdkResult.error(new Error("Failed to connect to parent"));
      if (globalThis.ResizeObserver == null)
        this.errorService.warning("ResizeObserver is not supported");
      else {
          ...
          for (const entry of entries)
            if (entry.target === document.body) {
              ...
              this.commsClient?.sendResizeEvent({
                body: { scrollWidth, scrollHeight, offsetWidth, offsetHeight },
              });
            }
        });
        const observe = () =>
      ...
      const elementClientHandler = {
        handleRenderElement: async (request) => {
          if (!this.element) {
            this.errorService.debug(
              "Received renderElement before Element initialized",
            );
        ...
        handleSetCapability: async (request) => {
          ...
          return new SetCapabilityResponse({
        ...
        handleSetEditPanelValue: async (request) => {
          ...
          return new SetEditPanelValueResponse({
            ...this.element.getElementData(),
          });
        },
      };
      this.errorService.info("Successfully connected to parent");
      this.commsClient = this.createElementClientComms(
        result.value,
        elementClientHandler,
      );
      return SdkResult.ok(this.commsClient);
    }
    get config() {
      if (!this.element) throw new Error("Element is uninitialized");
    ...
    async init(element) {
      this.errorService.info("Initializing Element");
      const onConfigChangeFn = element.onConfigChange ?? element.render;
      if (!onConfigChangeFn)
        return SdkResult.error(
          new Error("No render or onConfigChange function provided"),
        );
      this.element = new Element(
        element.defaultConfig,
        onConfigChangeFn,
        element.mapToCapabilities,
        element.mapToEditPanelValues,
      );
      const setupResult = await this.setupPromise;
      if (setupResult.isError) return SdkResult.error(setupResult.error);
      const commsClient = setupResult.data;
      let processInitElementResponseResult;
      try {
        const initElementResponse = await commsClient.sendInitElement(
          new InitElementRequest({
            config: JSON.stringify(element.defaultConfig),
          }),
        );
        processInitElementResponseResult =
          await this.processInitElementResponse(initElementResponse);
      } catch (e) {
        return SdkResult.error(e instanceof Error ? e : new Error(String(e)));
      }
      if (processInitElementResponseResult.isError)
        return SdkResult.error(processInitElementResponseResult.error);

      if (this.flushPendingRenderRequest !== undefined) {
        this.errorService.info(
          "Processing queued request after initialization",
        );
    ...
    async setConfig(config) {
      if (!this.commsClient)
        return SdkResult.error(new Error("SDK is disconnected"));
      if (!this.element)
        return SdkResult.error(new Error("Element is uninitialized"));
      await this.element.setConfig({ ...this.element.config, ...config });
      await this.commsClient.sendSetConfig(
        new SetConfigRequest({
          ...this.element.getElementData(),
    ...
    queueRenderElementRequest(request) {
      return new Promise((resolve) => {
        this.flushPendingRenderRequest = () =>
          this.processRenderElementRequest(request).then((response) =>
            resolve(response),
          );
      });
    }
    async processInitElementResponse(response) {
      ...
      if (response.fontEditable)
        this.element.setCapability(response.fontEditable);
    ...
    async processRenderElementRequest(request) {
      ...
      if (request.fontEditable)
        this.element.setCapability(request.fontEditable);
      return new RenderElementResponse({
        ...this.element.getElementData(),
        ...this.element.getCapabilityProtos(),
        ...this.element.getEditPanelValuesProtos(),
      });
    }
    constructor(connectToParent, createElementClientComms, errorService) {
  ...
  class Element {
    ...
    setCapability(proto) {
      switch (proto.type) {
        ...
        case "FONT_SIZEABLE":
          ...
          break;
        default:
          throw new UnreachableError(proto);
      }
    }
    ...
    setEditPanelValue(proto) {
      ...
      this._config = { ...this._config, [proto.id]: proto.value };
    }
    getElementData() {
    ...
    getCapabilityProtos() {
      const recolorables = [...this.capabilities.recolorables.entries()].map(
        ([id, recolorable]) =>
          new Recolorable({ id, value: recolorable.get() }),
      );
      const borderables = [...this.capabilities.borderables.entries()].map(
        ([id, borderable]) => new Borderable({ id, value: borderable.get() }),
      );
      const fontEditable = this.capabilities.fontEditable
        ? new FontEditable({
            id: this.capabilities.fontEditable.get(),
            url: "",
          })
        : undefined;
      const fontSizeable = this.capabilities.fontSizeable
        ? new FontSizeable({ size: this.capabilities.fontSizeable.get() })
        : undefined;
      return { recolorables, borderables, fontEditable, fontSizeable };
    }
    getEditPanelValuesProtos() {
      return {
        editPanelValues: [...this.editPanelValues.entries()].map(
          ([id, value]) => new EditPanelValue({ id, value }),
        ),
      };
    }
    getCapabilities() {
      ...
      if (capabilities.borderables?.length > 0) {
        const borderable = {
          ...
          set: (value) => {
            capabilities.borderables.forEach((borderable) =>
              borderable.set(value),
            );
          },
        };
  ...
  function getErrorService() {
    ...
    return (
      telemetry?.createChild("Element") ?? new ConsoleErrorService("Element")
    );
  }
  ...
  window.elementSdk = new ElementSdkImpl(
    connectToParent,
    (connection, handler) =>
      new ElementClientComms(connection, handler, errorService),
    errorService,
  );
})();
